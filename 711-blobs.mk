...
# App
#$(shell if [ ! -e vendor/aokp/prebuilt/common/app/Term.apk ]; then curl -L -o vendor/aokp/prebuilt/common/app/Term.apk -O -L http://jackpal.github.com/Android-Terminal-Emulator/downloads/Term.apk; fi;)
